...
int main()
{
    ...
    SimCamera * cam1 = new SimCamera("test camera1",20,20,20,0,0,0,10,0,0);
    SimCamera * cam2 = new SimCamera("test camera2",10,20,20,0,0,0,0,10,0);
    SimCamera * cam3 = new SimCamera("test camera3",00,30,20,0,0,0,0,0,10);
