 ...
 *
 *============================================================================*/
#ifndef _SIM_GRIDNODE_HPP_
#define _SIM_GRIDNODE_HPP_
//----------------------------------------------------------------------------//
//                                  INCLUDES                                  //
//----------------------------------------------------------------------------//
#include <irrlicht.h>
...
public:
    GridNode(ISceneNode * parent, ISceneManager* mgr, s32 id,
        ...
        ISceneNode(parent,mgr,id)
        {
            ...
            for(int i = 0; i <= x; i++)
            {
                vectorArrayX[i] = vector3df(i*step,0,z*step);
                vectorArrayX[(2*x+1)+i] = vector3df(i*step,0,-z*step);
                vectorArrayX[((4*x+2)-i)%(4*x+2)] = vector3df(-i*step,0,z*step);
                vectorArrayX[(2*x+1)-i] = vector3df(-i*step,0,-z*step);
            ...
            for(int i = 0; i <= z; i++)
            {
                vectorArrayZ[i] = vector3df(x*step,0,i*step);
                vectorArrayZ[(2*z+1)+i] = vector3df(-x*step,0,i*step);
                vectorArrayZ[((4*z+2)-i)%(4*z+2)] = vector3df(x*step,0,-i*step);
                vectorArrayZ[(2*z+1)-i] = vector3df(-x*step,0,-i*step);
